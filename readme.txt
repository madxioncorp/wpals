...
WP Auto Link Shortener is a plugin to create an automatic shortener link from permalinks on every posts we had. 

== Description ==

WPALS or WP Auto Link Shortener is a WordPress plugins which created for the easiest way to create shortener url from third parties automatically from the permalinks on every posts have. 
